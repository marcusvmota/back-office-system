...
export const createExperiencia = async (
  experienca: Experiencia
): Promise<Experiencia> => {
  const response = await api.post<Experiencia>("/experiencias", experienca)
...
export const getExperienciasByTipo = async (
  tipo: string
): Promise<Experiencia[]> => {
...
export const updateExperiencia = async (
  ...
  const response = await api.put<Experiencia>(
...
export const deleteExperiencia = async (
  id: number | undefined
): Promise<Experiencia> => {
...
export const createOrUpdateExperiencia = async (
  experiencia: Experiencia
): Promise<Experiencia> => {
  if (!experiencia.id) {
